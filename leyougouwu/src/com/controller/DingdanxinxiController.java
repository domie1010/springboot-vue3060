...
//	分页查询
	...
	public String dingdanxinxiList(@RequestParam(value="page",required=false)String page,
			ModelMap map,HttpSession session,Dingdanxinxi dingdanxinxi, String dingdanbianhao, String jine, String dingdanneirong, String yonghuming, String xingming, String shouji, String dizhi, String beizhu, String issh, String iszf){
	...
	public String dingdanxinxiList2(@RequestParam(value="page",required=false)String page,
			ModelMap map,HttpSession session,Dingdanxinxi dingdanxinxi, String dingdanbianhao, String jine, String dingdanneirong, String yonghuming, String xingming, String shouji, String dizhi, String beizhu, String issh,String iszf,HttpServletRequest request){
