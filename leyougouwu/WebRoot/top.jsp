      ...
      <td height="64"><table id="__01" width="100%" height="64" border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="61%" background="images/afff.gif"><table width="77%" height="64" border="0" align="center">
                <tr>
                  <td valign="bottom"><div style="font-family:宋体; color:#FFFFFF;  WIDTH: 100%; FONT-WEIGHT: bold; FONT-SIZE: 28px; margin-top:5pt">乐优购物商城</div></td>
                </tr>
            </table></td>
...
border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <td width="35%" align="right" valign="middle" class="STYLE7" style="padding-right:15px;"><img src="images/siteico.gif" />当前用户：<%=request.getSession().getAttribute("username")%> <img src="images/document.gif" />权限：<%=request.getSession().getAttribute("cx")%> <a href="index.jsp" target="_parent"><font class="STYLE7">返回首页</font></a> <a href="logout.jsp" target="_parent"><font class="STYLE7">退出</font></a></td>
          </tr>
      </table></td>
    </tr>
  </table>
