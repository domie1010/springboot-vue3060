...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
		...
		<tr ><td width="200">备注：</td><td><textarea name='beizhu' cols='50' rows='5' id='beizhu' onblur='' style='border:solid 1px #000000; color:#666666' ></textarea></td></tr>
						...
						<script language="javascript">document.form1.dingdanbianhao.value='${dingdanxinxi.dingdanbianhao}';</script>
	<script language="javascript">document.form1.jine.value='${dingdanxinxi.jine}';</script>
