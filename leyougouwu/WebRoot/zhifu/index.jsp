...
<table>
 <tr>
   ...
   <fieldset>
      <P class=STYLE1>本通道为<a href="http://www.jingmeiru.net" target="_blank"><strong>本系统收款帐号：xxxx</strong></a>客户专用，采用支付宝付款。请在支付前与本网站达成一致。</P>
      <P class="style2">请务必与<a href="http://www.jingmeiru.net" target="_blank"><strong>本系统收款帐号：xxxx</strong></a>确认好订单和货款后，再付款。可以在快速付款通道里的“标题”、“订单金额”、“付款方”和备注中填入相应的订单信息。</P>
