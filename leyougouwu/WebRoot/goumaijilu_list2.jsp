...
-->
    ...
    <td align='center'>${u.issh} </td>
		 ...
		 <%
			String sql="select * from goumaijilu where goumairen='"+(String)request.getSession().getAttribute("username")+"'  and issh='否'";
...
if(request.getParameter("leibiemingcheng")=="" ||request.getParameter("leibiemingcheng")==null ){}else{String nleibiemingcheng=new String(request.getParameter("leibiemingcheng").getBytes("8859_1"));if(nleibiemingcheng.contains("?")){nleibiemingcheng=request.getParameter("leibiemingcheng");}sql=sql+" and leibiemingcheng like '%"+nleibiemingcheng+"%'";}
...
while(RS_result.next()){
		...
		共计金额:<%=jinez%>； 
			...
			<input type="button" name="Submit" value="生成订单" onClick="javascript:location.href='dingdanxinxi_add.jsp?je=<%=jinez%>';" />
